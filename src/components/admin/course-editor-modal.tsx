        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          ...
          <div className="grid grid-cols-1 gap-5 sm:grid-cols-2">
            ...
            <div className="sm:col-span-2 rounded-xl border border-border-c bg-surface-alt p-4">
              ...
              <p className="mt-1.5 pl-6 text-xs text-ink-soft">
                Off by default. When on, the registration form offers a &quot;2 installments&quot; option next to &quot;Pay in full&quot;; the second half is chased automatically by SMS. When off, only pay-in-full is offered and the server rejects installment requests for this course.
              </p>
            </div>
            <div className="sm:col-span-2">
