# Reemora Documentation Index

| Document | Purpose |
|---|---|
| [Architecture.md](./Architecture.md) | System design, folder structure, rendering strategy, security model |
| [Database.md](./Database.md) | Full schema reference: tables, relationships, RLS, storage, functions |
...
| [ProjectRoadmap.md](./ProjectRoadmap.md) | Completed phases and future ideas |

Top-level release documents: [RELEASE_v1.md](../RELEASE_v1.md) (release summary) and [RELEASE_NOTES.md](../RELEASE_NOTES.md) (Release Candidate audit log).
